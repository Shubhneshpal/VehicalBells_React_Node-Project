...
const RegisterComponent = ({isLogin,setisLogin}) => {
  ...
  const handleSubmitRigister = async(e) => {
    ...
    setErrors(newErrors);
      ...
      if (isValid) {
        ...
        try {
          const response = await fetch('http://localhost:5000/registerModule/register', {
            method: 'POST',
            headers: {
          ...
          <div className="row">
            ...
            <div className="col-lg-5 left_card">
              <div className="googleLogin">
                ...
                <form method="POST" onSubmit={handleSubmitRigister}>
